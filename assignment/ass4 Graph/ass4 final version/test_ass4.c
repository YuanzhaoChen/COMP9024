...
void runtest(){
    ...
    printf("\n");
    TravelRoute("Harris Street","Goulburn","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt");
    printf("\n");
    TravelRoute("Martin Place","Goulburn","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt");
}
