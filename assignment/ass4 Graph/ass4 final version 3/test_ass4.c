...
void runtest(){
    ...
    reachableStops("Five Ways","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt");
    ...
    TravelRoute("Five Ways","Martin Place","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt"); 
    printf("\n");

    TravelRoute("Goulburn","Hunter Street","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt"); 
    printf("\n");

    TravelRoute("Bridge Street","Bondi Road","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt"); 
    printf("\n");

    TravelRoute("Albion Street","Bridge Street","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt");
    printf("\n");

    TravelRoute("Albion Street","George Street","BusStops.txt","BusNames.txt","BusRoute.txt","Distance.txt");
    printf("\n");
